package io.github.qenas.takeMeHome.tasks;
...
public class TeleportTask extends BukkitRunnable {
    ...
    public TeleportTask(JavaPlugin plugin, TeleportManager teleportManager, ScoreboardManager scoreboardManager, Player player, Location home) {
        this.plugin = plugin;
    ...
    public void run() {
        ...
        scoreboardManager.update(player, timer);
